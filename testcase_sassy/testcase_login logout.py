...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        ...
        driver.find_element_by_xpath("/html/body/div/div/div[2]/div[1]/div[2]/a").click() # SuperYou dropdown
        driver.find_element_by_xpath("/html/body/div/div/div[2]/div[1]/div[2]/div/div/ul/li[1]/a").click() # Logout button
