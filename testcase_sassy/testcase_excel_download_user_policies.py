...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        ...
        driver.find_element_by_link_text("User Policies").click() # User Policies
        driver.find_element_by_css_selector("rect").click() # Press checkmark
        driver.find_element_by_xpath("//div[@id='nova']/div/div[2]/div[2]/fade-transition/div/div[3]/div/div/div/div/div/div/div/ul/li/label").click() # Press "select all"
        driver.find_element_by_xpath("//div[@id='nova']/div/div[2]/div[2]/fade-transition/div/div[3]/div/div[2]/div/div/select").click() # Press action dropdown
        Select(driver.find_element_by_xpath("//div[@id='nova']/div/div[2]/div[2]/fade-transition/div/div[3]/div/div[2]/div/div/select")).select_by_visible_text("Download Excel") 
        time.sleep(1)
        driver.find_element_by_xpath("//div[@id='nova']/div/div[2]/div[2]/fade-transition/div/div[3]/div/div[2]/div/div/select").click() # Press play button
        driver.find_element_by_xpath("//div[@id='nova']/div/div[2]/div[2]/fade-transition/div/div[3]/div/div[2]/div/div/button").click() # Press filename field
        time.sleep(1)
