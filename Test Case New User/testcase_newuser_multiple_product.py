...
class TestCaseMultipleProduct(unittest.TestCase):
    ...
    def test_case_NewUser_MultipleProduct(self):
        ...
        time.sleep(1)
        driver.find_element_by_xpath("/html/body/div[3]/div[1]/section[2]/div/div/div[2]/div[1]/div/div[3]/ul/li/div/a").click() #Klik Beli Plan
        time.sleep(1)

        # Go to Home
        driver.find_element_by_xpath("/html/body/div[3]/header/div[2]/div[3]/div/div/a").click() #Klik Beli Plan
        time.sleep(1)
