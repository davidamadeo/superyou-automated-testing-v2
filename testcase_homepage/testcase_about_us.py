...
class TestLeadGen(unittest.TestCase):
    ...
    def test_case_LeadGen(self):
        ...
        driver.find_element_by_id("tentang-superyou-header").click() # Tentang Super You header

        driver.execute_script("window.history.go(-1)") # Go back

        driver.execute_script("window.scrollTo(0, 3500)") # Scroll to footer
        
        driver.find_element_by_id("tentang-superyou-footer").click() # Tentang Super You footer
