...
class TestCaseSingleProduct(unittest.TestCase):
    ...
    def test_case_NewUser_SingleProduct(self):
        ...
        time.sleep(5)
        element = driver.find_elements_by_css_selector("#form-user .sum-assured-reaches-limit p")

        assert "Kamu tidak dapat menambah produk lagi, Uang Pertanggungan yang didapat sudah mencapai batas Rp 1.500.000.000.Silakan ganti salah satu produk atau Tertanggung untuk melanjutkan pembelian." in element[0].text
