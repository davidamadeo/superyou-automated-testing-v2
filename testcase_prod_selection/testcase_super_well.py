...
class TestCaseLogin(unittest.TestCase):
    ...
    def test_case_login(self):
        ...
        nodes[0].click()
        driver.find_element_by_xpath("//div[@id='su-base-select']/div/ul/li[6]").click() # Click Super Well Protection
        ...
        nodes[1].click()
        driver.find_element_by_xpath("//div[@id='su-base-select']/div/ul/li[1]").click() # Click Silver Plan

        time.sleep(2)

        nodes[2].click()
        driver.find_element_by_xpath("//div[@id='su-base-select']/div/ul/li[1]").click() # Click Laki Laki

        time.sleep(2)

        assert "Kamu hanya dapat memiliki 1 Polis Super Well Protection untuk 1 Tertanggung" in driver.page_source
