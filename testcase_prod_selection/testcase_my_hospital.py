...
class TestCaseLogin(unittest.TestCase):
    ...
    def test_case_login(self):
        ...
        nodes[0].click()
        driver.find_element_by_xpath("//div[@id='su-base-select']/div/ul/li[5]").click() # Click My Hospital Protection
        ...
        assert "Kamu hanya dapat memiliki 1 Polis My Hospital Protection untuk 1 Tertanggung" in driver.page_source
