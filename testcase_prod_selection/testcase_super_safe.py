...
class TestCaseLogin(unittest.TestCase):
    ...
    def test_case_login(self):
        ...
        nodes[0].click()
        driver.find_element_by_xpath("//div[@id='su-base-select']/div/ul/li[2]").click() # Click Super Safe Protection

        nodes[1].click()
        driver.find_element_by_xpath("//div[@id='su-base-select']/div/ul/li[2]").click() # Click Silver Plan
