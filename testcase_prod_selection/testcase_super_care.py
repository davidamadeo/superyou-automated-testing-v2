...
class TestCaseLogin(unittest.TestCase):
    ...
    def test_case_login(self):
        ...
        nodes[0].click()
        driver.find_element_by_xpath("//div[@id='su-base-select']/div/ul/li[3]").click() # Click Super Care Protection
        ...
        nodes[1].click()
        driver.find_element_by_xpath("//div[@id='su-base-select']/div/ul/li[1]").click() # Click Silver Plan dengan Santunan Tunai Harian COVID 19

        time.sleep(2)

        driver.find_element_by_css_selector("#form-user .form-product-selection .radio label[for='claimMethod-0']").click()

        time.sleep(2)

        assert "Kamu hanya dapat memiliki 1 Polis Super Care Protection untuk 1 Tertanggung" in driver.page_source
